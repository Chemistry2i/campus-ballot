...
function Register() {
  ...
  const handleChange = (e) => {
    ...
    if (name === "faculty") {
      ...
      setForm((f) => {
        // sanitize: allow digits only for studentId (prevents typing/pasting non-digits)
  ...
  if (form.role === 'student') {
    ...
    // Ensure the student ID is numeric (only digits)
    if (!/^\d+$/.test(studentId)) {
      Swal.fire('Invalid Student ID', 'Student ID must contain only numbers (digits 0-9).', 'error');
      return;
    }
