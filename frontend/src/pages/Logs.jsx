                        ...
                        {currentLogs.map((log) => (
                          <tr key={log._id}>
                            ...
                            <td style={{ fontSize: '0.8rem', padding: '0.35rem 0.5rem' }}>
                              ...
                              <span className="text-truncate d-inline-block" style={{ maxWidth: '200px', fontSize: '0.8rem !important', padding: '0.35rem 0.5rem', lineHeight: 1.3, verticalAlign: 'middle', fontWeight: 400, color: '#222', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale', fontFamily: 'inherit', fontStyle: 'normal', fontVariant: 'normal', fontStretch: 'normal', letterSpacing: 'normal', textAlign: 'left', background: 'none', border: 'none', outline: 'none', boxShadow: 'none', margin: 0, display: 'inline-block' }}>
