...
//     setVerifying(true);
//     try {
//       const res = await axios.get(`https://curly-tribble-xqvw69x9749cvqqq-5000.app.github.dev/api/auth/verify/${token}`);
...
function VerifyEmail() {
  ...
  const handleResendVerification = async () => {
    ...
    if (email) {
      setResending(true);
      try {
        const res = await axios.post('https://curly-tribble-xqvw69x9749cvqqq-5000.app.github.dev/api/auth/resend-verification', {
          email: email
        });
