...
//     setVerifying(true);
//     try {
//       const res = await axios.get(`https://laughing-memory-wrjgjx7g5qqq3g559-5000.app.github.dev/api/auth/verify/${token}`);
...
function VerifyEmail() {
  ...
  const handleResendVerification = async () => {
    ...
    if (email) {
      setResending(true);
      try {
        const res = await axios.post('https://laughing-memory-wrjgjx7g5qqq3g559-5000.app.github.dev/api/auth/resend-verification', {
          email: email
        });
